...
def update(Mass, Momx, Momy, Momz, Energy, dx, gamma, courant_fac, Bx, By, Bz):
    ...
    rho_XL, rho_XR, rho_YL, rho_YR, rho_ZL, rho_ZR = extrapolate_to_face(rho, rho_dx, rho_dy, rho_dz, dx)
    vx_XL, vx_XR, vx_YL, vx_YR, vx_ZL, vx_ZR = extrapolate_to_face(vx, vx_dx, vx_dy, vx_dz, dx)
    vy_XL, vy_XR, vy_YL, vy_YR, vy_ZL, vy_ZR = extrapolate_to_face(vy, vy_dx, vy_dy, vy_dz, dx)
    vz_XL, vz_XR, vz_YL, vz_YR, vz_ZL, vz_ZR = extrapolate_to_face(vz, vz_dx, vz_dy, vz_dz, dx)
    P_XL, P_XR, P_YL, P_YR, P_ZL, P_ZR = extrapolate_to_face(P, P_dx, P_dy, P_dz, dx)
    Bx_XL, Bx_XR, Bx_YL, Bx_YR, Bx_ZL, Bx_ZR = extrapolate_to_face(Bx, Bx_dx, Bx_dy, Bx_dz, dx)
    By_XL, By_XR, By_YL, By_YR, By_ZL, By_ZR = extrapolate_to_face(By, By_dx, By_dy, By_dz, dx)
    Bz_XL, Bz_XR, Bz_YL, Bz_YR, Bz_ZL, Bz_ZR = extrapolate_to_face(Bz, Bz_dx, Bz_dy, Bz_dz, dx)
